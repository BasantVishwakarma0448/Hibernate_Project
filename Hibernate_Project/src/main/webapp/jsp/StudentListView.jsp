...
<%@page import="com.util.HTMLUtility"%>
<%@page import="com.util.ServletUtility"%>
<%@page import="com.controller.StudentListCtl"%>
<%@page import="com.dto.CollegeDTO" %>
<%@page import="com.model.ModelFactory" %>
<%@page import="com.model.CollegeModelInt" %>
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.dto.StudentDTO"
